        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            PrintWriter printWriter = new PrintWriter(outputStream);
               ...
               printWriter.println(staticString);
                ...
                if (i != 0){printWriter.println(i);}
                else printWriter.println("noIntI");
                if (j != 0){printWriter.println(j);}
                else printWriter.println("noIntJ");
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(inputStream));
                while (bufferedReader.ready()){
                    ...
                    if (!s1.equals("noIntI")){i = Integer.parseInt(s1);}
                    if (!s2.equals("noIntJ")){j = Integer.parseInt(s2);}
                }
        }
