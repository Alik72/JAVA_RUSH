...
public class Solution {
    ...
    public static boolean isAllModifiersContainSpecificModifier(int allModifiers, int specificModifier) {
        ...
        boolean a = Modifier.isPublic(specificModifier);
        boolean b = Modifier.isPublic(allModifiers);
        boolean c = Modifier.isStatic(allModifiers);
        boolean d = Modifier.isStatic(allModifiers);
        if ((a & b ) == true){
            return true;
        }
        if ((c & d ) == true)
